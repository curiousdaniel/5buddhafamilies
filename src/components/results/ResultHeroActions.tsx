...
export default function ResultHeroActions({
  ...
  const shareText = `I just discovered my Five Buddha Families composition — ${primary.name} with ${secondary.name} influences. Take the quiz to discover yours!`
    ...
    <div className="flex flex-wrap items-center justify-center gap-1 mt-6">
      ...
      <div className="relative" ref={shareDropdownRef}>
        <IconButton
          ...
          title="Share"
          className={shareOpen ? 'text-gold bg-gold/10' : ''}
        >
          <ShareIcon />
        </IconButton>
        {shareOpen && (
